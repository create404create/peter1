// USA States Area Codes Database
...
for (const codes of Object.values(USA_STATES_AREA_CODES)) {
...
if (typeof window !== 'undefined') {
    window.USA_STATES_AREA_CODES = USA_STATES_AREA_CODES;
    window.ALL_AREA_CODES = ALL_AREA_CODES;
    window.getStateFromAreaCode = getStateFromAreaCode;
    window.isValidAreaCode = isValidAreaCode;
}
